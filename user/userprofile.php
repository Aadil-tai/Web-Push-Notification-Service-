...
if(isset($_POST['submit']))
{
 ...
 $sql=mysqli_query($conn,"insert into user(name,contactno,Email,password) values('$user','$doccontactno','$Email','$password')");
if($sql)
{
...
<html lang="en">
    <head>
        <title>user |Add security authority</title>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="https://via.placeholder.com/110x110" alt="user" class="rounded-circle p-1 bg-primary" width="110">
                            <div class="mt-3">
                                <h4>user</h4>
                                <p class="mb-1">user</p>
                                <p class="font-size-sm"><Address>address</Address></p>
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <span class="text-white">https://user.com</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="card">
                    ...
                    <form role="form" name="adddoc" method="post" onSubmit="return valid();">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="Email" name="Email" onBlur="checkemailAvailability()" class="form-control"  />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="doccontact" id="doccontact" class="form-control"  />
                            </div>
                        </div>
                   ...
                   <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                            <input type="password" name="cfpass" class="form-control"  required="required">
                            </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <button type="submit" name="submit" id="submit" class="btn btn-light px-4">Submit</button> 
                            </div>
                         </div>
