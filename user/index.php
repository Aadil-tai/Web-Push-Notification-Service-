...
echo "<script type='text/javascript'> document.location = 'indexdash.php'; </script>";
} else{
							...
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="text-center">
										<h3 class="">Hey user</h3>
									</div>
									<div class="login-separater text-center mb-100"> <span>SIGN IN WITH YOUR VALID CREDENTIALS</span>
										<hr/>
									</div>
									<div class="form-body">
								<form class="row g-3" method="POST">
											<div class="col-12" >
												...
												<input type="email" class="form-control" id="username" type="text" required="" name="email" id="inputLastEnterUsername" placeholder="Enter Email Address" />
											</div>
											<div class="col-12">
												<label for="inputChoosePassword" class="form-label">Enter Password</label>
												<div class="input-group" id="show_hide_password">
													<input type="password" class="form-control border-end-0" name="password" required="" name="mypassword"class="form-control border-start-0" id="inputLastEnterPassword" placeholder="Enter Password" /> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
												</div>
											</div>
<!-- 											<div class="col-md-6">
 ...
 -->											<div class="col-12">
												<div class="d-grid">
													...
													<button type="submit" class="btn btn-light" name="login"><i class="bx bxs-lock-open"></i>Sign in</button>
												</div>
											</div>
										</form>
									</div>
