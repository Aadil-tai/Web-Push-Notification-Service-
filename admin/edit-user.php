...
if(isset($_POST['submit']))
  {
	...
	$sql="UPDATE users SET name=(:name), email=(:email),Password=:newpassword, gender=(:gender), mobile=(:mobileno), package=(:package), Image=(:image) WHERE id=(:idedit)";
...
<label class="col-sm-2 control-label">package<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="package" class="form-control" required value="<?php echo htmlentities($result->package);?>">
</div>
</div>
...
<div class="form-group">
	<div class="col-sm-8 col-sm-offset-2">
		<img src="../user/images/<?php echo htmlentities($result->image);?>" width="150px"/>
