...
$sql ="INSERT INTO users(name,email, password, gender, mobile, package, image, status) VALUES(:name, :email, :password, :gender, :mobileno, :package, :image, 1)";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h1 class="text-center text-bold mt-2x">Add Users</h1>
						...
						<div class="well row pt-2x pb-3x bk-light text-center">
                         <form method="post" class="form-horizontal" enctype="multipart/form-data" name="regform" onSubmit="return validate();">
                            ...
                            <label class="col-sm-1 control-label">package<span style="color:red">*</span></label>
                            <div class="col-sm-5">
